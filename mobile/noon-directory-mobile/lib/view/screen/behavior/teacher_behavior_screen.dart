...
class _TeacherBehaviorScreenState extends State<TeacherBehaviorScreen> {
            ...
            children: [
              ...
              _buildAnimatedDropdownCard<ClassInfo>(
                ...
                onSelected: (v) {
                  ...
                  controller.sections.clear();
                  controller.subjects.clear();
                  controller.allSections.clear();
                  controller.allSubjects.clear();
                  if (v?.id != null) {
              ...
              _buildAnimatedDropdownCard<Section>(
                ...
                onSelected: (v) => controller.setSection(v),
              ),
              ...
              _buildAnimatedDropdownCard<TeacherSubject>(
                ...
                onSelected: (v) => controller.setSubject(v),
              ),
  ...
  Widget _buildHeaderSection() {
    return Column(
      ...
      children: [
        ...
        Text(
          "يرجى اختيار المرحلة والصف للوصول لسجل الطلاب",
  ...
  Widget _buildGradientButton(BehaviorController controller) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          Get.toNamed(ScreensUrls.teacherStudentsBehaviorScreenUrl);
        },
        ...
        child: Text(
          AppLanguage.showStudentsHistory.tr,
          style: AppTextStyles.bold14.copyWith(
            color: Colors.white,
            fontSize: 17,
          ),
