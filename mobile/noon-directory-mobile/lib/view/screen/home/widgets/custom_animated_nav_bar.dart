...
class CustomAnimatedNavBar extends StatefulWidget {
  ...
  /// Index of the center/home item that should be visually elevated
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        // Fix for Arabic/RTL: Calculate visual index based on text direction.
        ...
        // Animate smoothly between previous and new position
        ...
        return Stack(
          ...
          children: [
            ...
            Positioned(
              bottom:
                  42, // Circle bottom at y=35 from top (70 - 35), placing its center precisely at y=10
              left: currentPosition - 25, // center the circle (radius 25)
              child: Container(
                width: 50,
                height: 50,
...
class NotchPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Left line up to the notch
    path.lineTo(notchCenter - notchRadius - cornerRadius, 0);

    // Rounded corner going down
    ...
    // Draw shadow slightly below to give it a neat lift
