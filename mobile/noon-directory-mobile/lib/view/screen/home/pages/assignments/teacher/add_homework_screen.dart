...
class _AddHomeworkScreenState extends State<AddHomeworkScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        appBarName: isEdit ? AppLanguage.editHomework.tr : "إضافة واجب جديد",
        isLeading: true,
        press: () => Get.back(),
      ),
      body: SafeArea(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 3. Section (Multi-select style within card)
                ...
                if (controller.files.isNotEmpty)
                  FilesListWidget(
                    ...
                    onRemoveFilePressed: controller.removeFileFromList,
                  ),
              ],
            ),
          );
      ...
      bottomNavigationBar: Obx(() {
        return IgnorePointer(
          ...
          child: BottomNavbar(
            ...
            text: isEdit
                ? AppLanguage.editHomework.tr
                : AppLanguage.icAddHomework.tr,
            onTap: !isEdit
                ? () async {
  ...
  // ? Styled selector for students to target specific groups
  ...
  // ? Centralized input card for Title and Description for better grouping
    ...
    return Column(
      children: [
        ...
        _buildTextField(
          ...
          hint: AppLanguage.homeworkDetailsStr.tr,
