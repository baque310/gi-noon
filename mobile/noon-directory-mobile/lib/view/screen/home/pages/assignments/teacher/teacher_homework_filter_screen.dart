...
import 'package:noon/view/screen/home/pages/assignments/teacher/teacher_homework_section.dart';
import 'package:noon/core/constant/screens_urls.dart';

class TeacherHomeworkFilterScreen extends StatefulWidget {
  const TeacherHomeworkFilterScreen({super.key});

  @override
  State<TeacherHomeworkFilterScreen> createState() =>
      _TeacherHomeworkFilterScreenState();
}

class _TeacherHomeworkFilterScreenState
    extends State<TeacherHomeworkFilterScreen> {
  int? expandedIndex;
          ...
          child: Column(
            ...
            children: [
              ...
              _buildAnimatedCard<Section>(
                ...
                onSelected: (v) {
                  controller.searchSectionValue(v);
                },
              ),
              ...
              _buildAnimatedCard<TeacherSubject>(
                ...
                onSelected: (v) {
                  controller.searchSubjectValue(v);
                },
              ),
  ...
  Widget _buildDateCard(HomeworkController controller) {
    return Container(
      margin: const EdgeInsets.only(bottom: 16),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildActionButton() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Get.to(() => TeacherHomeworkSection(), arguments: {'filtered': true});
        },
